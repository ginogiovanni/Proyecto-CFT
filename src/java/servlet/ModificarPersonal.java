...
public class ModificarPersonal extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String apellidos = request.getParameter("apellidosM");
        String sexo = request.getParameter("sexoM");
        ...
        Personal p = new Personal(rut, nombre, apellidos, sexo, direccion, telefono, email);
        PersonalController pc = new PersonalController();
        if (pc.modificarPersonal(p)) {
