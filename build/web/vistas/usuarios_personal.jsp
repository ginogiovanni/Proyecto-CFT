<%-- 
    Document   : usuarios_personal
    Created on : 22-11-2017, 23:50:51
    Author     : Hawk
--%>

<%@page import="controlador.PersonalController"%>
<%@page import="controlador.UsuariosPersonalController"%>
...
<ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active">Administrar Usuarios Personal</li>
</ol>
<div id="accordion" role="tablist" aria-multiselectable="true">
    <div class="card">
        <div class="card-header" role="tab" id="headingOne">
            <h5 class="mb-0">
                <a data-toggle="collapse" data-parent="#accordion" href="#collapseUsuariosPersonal" aria-expanded="true" aria-controls="collapseOne">
                    <i class="fa fa-plus" aria-hidden="true"></i> Crear nuevo usuario personal
                </a>
            </h5>
        </div>
        ...
        <div id="collapseUsuariosPersonal" class="collapse" role="tabpanel" aria-labelledby="headingOne">
            <div class="card-body">
                <form method="POST" id="frm-usuariosPersonal" action="${pageContext.request.contextPath}/CrearUsuariosPersonal">
                    ...
                    <div class="form-group">
                        <label for="rut">Seleccione personal</label>
...
<div class="row">
    <div class="col-12">
        <% UsuariosPersonalController ic = new UsuariosPersonalController();%>
        ...
        <div class="card-header" role="tab" id="headingOne">
            <h5 class="mb-0">
                <a data-toggle="collapse" data-parent="#accordion" href="#collapseModificarUsuario" aria-expanded="true" aria-controls="collapseOne">
                    <i class="fa fa-pencil-square-o" aria-hidden="true"></i> Modificar Usuario Personal
                </a>
            </h5>
        </div>
        <div id="collapseModificarUsuario" class="collapse" role="tabpanel" aria-labelledby="headingOne">
            <div class="card-body">
                <form method="POST" id="frm-modificarUsuario" action="${pageContext.request.contextPath}/ModificarUsuario">
                    <div class="form-group">
